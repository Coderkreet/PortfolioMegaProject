    ...
    <div className="row align-items-center">
      ...
      >
        <div className="home-one-progress home-3-pro">
          ...
          <div className="meter cadetblue">
            <span data-progress={50} style={{ width: 50 }} />
          </div>
        </div>
      </div>
      <div
      ...
      >
        <div className="home-one-progress home-3-pro">
          ...
          <h5>Development</h5>
          <div className="meter cadetblue">
            <span data-progress={75} style={{ width: 75 }} />
          </div>
        </div>
      </div>
      <div
      ...
      >
        <div className="home-one-progress home-3-pro">
          ...
          <div className="meter cadetblue">
            <span data-progress={38} style={{ width: 38 }} />
          </div>
        </div>
      </div>
      <div
      ...
      >
        <div className="home-one-progress home-3-pro">
          ...
          <div className="meter cadetblue">
            <span data-progress={63} style={{ width: 63 }} />
          </div>
        </div>
      </div>
    </div>
...
<section id="services" class="services gap no-top">
	<div class="container">
    ...
    <div className="portfolios">
      <div className="filters portfolio-controllers-container">
        ...
        >
          <button
            type="button"
            className="magic-hover magic-hover__square button is-checked filter-btn active-work"
            data-filter=""
          >
            Show All
          </button>
          <button
            type="button"
            className="magic-hover magic-hover__square filter-btn"
            data-filter=".Design"
          >
            Design
          </button>
          ...
          <div className="portfolio-detail">
            <div className="portfolio-img hover06">
              <figure>
                <img
                  alt="profile img"
                  src="https://via.placeholder.com/336x406"
                />
              </figure>
              <a className="magic-hover magic-hover__square" href="#">
                List of Brands
          ...
          <div className="portfolio-detail">
            <div className="portfolio-img hover06">
              <figure>
                <img
                  alt="profile img"
                  src="https://via.placeholder.com/366x271"
                />
              </figure>
              <a className="magic-hover magic-hover__square" href="#">
                Creative Studio
