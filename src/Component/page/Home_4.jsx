...
import { FaBars, FaBriefcase, FaDownload, FaEnvelopeOpen, FaFacebook, FaFolder, FaGraduationCap, FaHome, FaICursor, FaInstagram, FaLinkedin, FaSpinner, FaStumbleupon, FaTwitter, FaUser } from 'react-icons/fa'
...
const toggleExperience = () => {
  ...
  <header className="pages-one">
    <a href="javascript:void(0)" className="bar-menu">
      ...
      <div className="tabs-nav js-tabs-nav" style={{top : "-60px"}} id="fade-example">
        <ul className="menu-item main-menu tabs-nav__list">
          <li onClick={()=>{toggleFunc("Home")}} className="active tabs-nav__item js-tabs-item">
            ...
            >
              <i className="icon-home" > <FaHome/> </i>
              <span>Home</span>
            </a>
          </li>
          ...
          <li onClick={()=>{toggleFunc("Portfolio")}} className="tabs-nav__item js-tabs-item">
            <a
              ...
              className="tabs-nav__link js-tabs-link magic-hover magic-hover__square"
            >
              <i className="icon-briefcase" > <FaBriefcase/></i>
              <span>Portfolio</span>
            </a>
          </li>
          ...
          <li onClick={()=>{toggleFunc("Contact")}} className="tabs-nav__item js-tabs-item">
            <a
              ...
              className="tabs-nav__link js-tabs-link magic-hover magic-hover__square"
            >
              <i className="icon-envelope-open" > <FaEnvelopeOpen/></i>
              <span>Contact</span>
            </a>
          </li>
        </ul>
        ...
        <a className="magic-hover magic-hover__square" href="#">
          <i className="icon-cursor" > <FaICursor/> </i>
        </a>
        <ul className="social-media-icon header">
          <li></li>
          <li>
            <a
            ...
            >
              <i className="fa-brands fa-facebook-f" ><FaFacebook/> </i>
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            <a
              ...
              href="javascript:void(0)"
            >
              <i className="fa-brands fa-instagram"  > <FaTwitter/></i>
            </a>
          </li>
        </ul>
      </div>
    ...
    <div className="mobile-nav" id="mobile-nav" style={{ display: "block" }}>
      ...
      <ul className="menu-item main-menu tabs-nav__list">
        <li className="active tabs-nav__item js-tabs-item">
          <a
            
            className="tabs-nav__link js-tabs-link new-tabe nav-anim magic-hover magic-hover__square"
          >
            <i className="icon-home" > <FaHome/></i>
            <span>Home</span>
          </a>
        ...
        <div className="col-lg-4">
          <div className="user-info" style={{height:"45rem"}} >
            ...
            <ul className="social-media">
              ...
              <li>
                <a className="magic-hover magic-hover__square" href="#">
                  <i className="fa-brands fa-stumbleupon" > <FaStumbleupon/></i>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="row align-items-center">
          <div className="col-xl-8 col-lg-12">
            ...
            >
              ...
              <a
                href="javascript:void(0)"
                className="lightbox-toggle button button--moema button--text-thick button--text-upper button--size-s"
              >
                Start Consulting
              </a>
          ...
          <div className="col-xl-8 col-lg-12">
            ...
            <div className="who-i-am headings">
              ...
              <p>
                ...
                augue. Aenean arcu libe ro, facilisis et nisi non, tempus
                faucibus tortor. Mauris vel nulla aliquam, pell entesque enim
                ac, faucibus tortor. Nulla odio nibh, cursus sit amet urna id,
                digni ssim ilimAenean arcu libe ro, facilisis et nisi non,
                tempus faucibus tortor.
              </p>
            </div>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="service">
                    ...
                    <p>
                      Lorem ipsum indolor st amet, cm etctetur adips locing
                      elit, sedi din m indolor st ilmes.
                    </p>
                  </div>
                </div>
                <div className="col-lg-6">
            ...
            <div className="headings clients-reviews">
              ...
              <div className="photo owl-carousel owl-theme">
                <div className="quote item" data-hash="zero">
                  ...
                  <div>
                    <h6>
                      We help our clients from the definition of their strategy
                      to the realization of their digital ecosystem. At the
                      heart of our approach is the constant search for the
                      juncture between aesthetic.
                    </h6>
                    <a className="magic-hover magic-hover__square" href="#">
                      Edison Cavani
                    </a>
              ...
              <div className="photo-preview">
                <a
                  className="magic-hover magic-hover__square secondary url"
                  href="#zero"
                >
                  <img alt="slider" src="https://via.placeholder.com/80x80" />
                </a>
                <a
                  className="magic-hover magic-hover__square secondary url"
                  href="#one"
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6 col-sm-6">
                  <div className="client">
                    <img
                      alt="clients"
                      src="https://via.placeholder.com/122x68"
                    />
                    <a href="#" className="magic-hover magic-hover__square">
                      www.winsfolio.net
                    </a>
                  </div>
                </div>
              ...
              <div className="col-lg-6">
                ...
                <div className="education">
                  ...
                  <div className="studies">
                    ...
                    <p>
                      Lorem ipsum indolor st amet, cmetc ur adips locing elit,
                      sedi dinm indolo sum indolor st ailmes.
                    </p>
                  </div>
                </div>
                <div className="education">
          ...
          <div className="col-xl-8 col-lg-12">
            ...
            <div className="filters portfolio-controllers-container">
              ...
              >
                <button
                  type="button"
                  className="button is-checked filter-btn magic-hover magic-hover__square active-work"
                  data-filter=""
                >
                  Show All
                </button>
                <button
                  type="button"
                  className="filter-btn magic-hover magic-hover__square"
                  data-filter=".Design"
                >
                  Design
                </button>
                ...
                <div className="portfolio-detail">
                  <div className="portfolio-img hover06">
                    <figure>
                      <img
                        alt="profile img"
                        src="https://via.placeholder.com/318x236"
                      />
                    </figure>
                    <a
                      className="magic-hover magic-hover__square"
                ...
                <div className="portfolio-detail">
                  <div className="portfolio-img hover06">
                    <figure>
                      <img
                        alt="profile img"
                        src="https://via.placeholder.com/318x353"
                      />
                    </figure>
                    <a
                      className="magic-hover magic-hover__square"
            ...
            <div className="news-img">
              <div className="news-data gapp">
                ...
                <a
                  ...
                  href="blog-details-1.html"
                >
                  Summary of Personal and Business Experiences
                </a>
                <div className="news-img-girl">
                  <img alt="girl" src="https://via.placeholder.com/60x60" />
                  <div>
            ...
            <div className="news-img">
              ...
              <div className="news-data">
                ...
                <a
                  ...
                  href="blog-details-1.html"
                >
                  Creating a Better IT Business Solutions
                </a>
                <div className="news-img-girl">
                  <img alt="girl" src="https://via.placeholder.com/60x60" />
                  <div>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="contact-info">
                  ...
                  <h5>Street No 25, New Town 7896 Fa, San Francisco</h5>
                  <h4>
                    Monday-Friday:<span> 10am - 9 PM</span>
                  </h4>
                </div>
              </div>
              <div className="col-lg-6">
