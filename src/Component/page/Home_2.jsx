...
<>
      ...
      <div className="row">
        ...
        >
          <div className="service-data one">
            ...
            <p>
              Lorem ipm dolor amet, cons magm maiores Ipsa dolor sit magnam
              maores.
            </p>
          </div>
        </div>
  ...
  <section className="my-project hom3 two gap no-top">
    <div className="container">
          ...
          <div className="portfolio-detail">
            <div className="portfolio-img hover06">
              <figure>
                <img
                  alt="profile img"
                  src="https://via.placeholder.com/586x387"
                />
              </figure>
              <a
                className="magic-hover magic-hover__square"
          ...
          <div className="portfolio-detail">
            <div className="portfolio-img hover06">
              <figure>
                <img
                  alt="profile img"
                  src="https://via.placeholder.com/366x261"
                />
              </figure>
              <a
                className="magic-hover magic-hover__square"
      ...
      >
        <a
          href="#"
          className="magic-hover magic-hover__square button button--moema button--text-thick button--text-upper button--size-s"
        >
          <i className="fa-solid fa-spinner" /> Load More
        </a>
      </div>
    </div>
  </section>
  ...
  <section
    className="work-experience-two gap"
  ...
  >
    <div className="container">
      ...
      <div
        className="row present-data-home-page owl-carousel owl-theme"
        data-aos="fade-up"
        data-aos-delay={300}
        data-aos-duration={400}
      >
        <div className="col-lg-12 item">
          <div className="to-present">
            ...
            <div className="envato-studio">
              <h4>Envato Studio</h4>
              <p>
                Lorem ipsum indolor st amet, cmetc ur locing elit, sedi dinm
                indolo sum ind ol m indolor st amet, cmetcilmes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="item zoom-slider-img">
          ...
          <div className="zoom-slider-data">
            ...
            <h5>
              ...
              >
                Interview Photographer Mark Seliger Agency
              </a>
            </h5>
          </div>
        </div>
